...
def test_age_alone_never_authorizes_slot_backend_cleanup() -> None:
    ...
    assert module.stale_owner_evidence(_state()) == "mop_free_idle_no_owner_or_dependency"
    for state in (
...
def test_active_old_convex_watch_is_preserved() -> None:
    ...
    sqlite = subprocess.CompletedProcess([], 0, "3|active|1|0|0|running tests|#7635|fix/7635|7635|2026-09-07T00:00:00Z\n", "")
...
def test_proven_orphan_is_revalidated_before_term_and_kill() -> None:
    ...
    row = {
        ...
        "start_time": "Mon Sep  7 00:00:00 2026",
        "associated_slot": 3,
        "owner_proof": "mop_free_idle_no_owner_or_dependency",
    }
