  ...
  app.post("/slots/:slotNum/release", async (c) => {
    ...
    const request: NativeSlotReleaseRequest = {
      ...
      expected_tuple: {
        ...
        pr: (body.expected_pr ?? null) as number | null,
        branch: (body.expected_branch ?? null) as string | null,
        head_sha: (body.expected_head_sha ?? null) as string | null,
        work_kind: (body.expected_work_kind ?? null) as string | null,
        handoff_id: (body.expected_handoff_id ?? null) as string | null,
        claimed_at: (body.expected_claimed_at ?? null) as string | null,
      },
